...
{
    Invoke-WebRequest "https://github.com/Superbelko/ohmygentool/releases/download/v0.2.0/gentool-v0.2.0-win64.zip" -OutFile ../deps/gentool.zip -UseBasicParsing
}
...
{
    Invoke-WebRequest "https://github.com/ocornut/imgui/archive/v1.79.zip" -OutFile ../deps/imgui.zip -UseBasicParsing
}
